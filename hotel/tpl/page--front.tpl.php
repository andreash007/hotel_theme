    ...
    <div class="container <?php print $grid; ?>">
      <div class="grid-inner clearfix">
        ...
        <div id="footer" class="clearfix">
          <strong class="logo">
            <a href="/"><img width="33" height="42" src="http://atlanticbyronbay.com.au/wp-content/uploads/2014/12/logo-footer.png" class="attachment-footer-logo-thumbnail" alt="THome Page">
              <div class="logo-text">Cosmopolitan Motel </div>
            </a>
          </strong>
          <?php print $footer; ?>          
        </div>
